...
With the DApp running locally, you can move on to [Production deployment](./05-deployment.mdx) to deploy the frontend to Vercel and the proof server to Railway.